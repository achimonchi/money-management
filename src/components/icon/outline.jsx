...
export const InboxOutline=({size,className})=>{
    return <svg className={className} width={size ?? 18} height={size ?? 18} fill="none"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
export const ShoppingBagOutline=({size,className})=>{
    return <svg className={className} width={size ?? 18} height={size ?? 18} fill="none"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
